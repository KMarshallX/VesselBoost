...
# Statement of Need
Magnetic resonance angiography (MRA) performed at ultra-high field provides the unique opportunity to study the arteries of the living human brain at the mesoscopic level [@bollmann_imaging_2022]. From this, insights into the blood supply of the brain (cite Hirsch, 2012) and vascular disease affecting small vessels [@hetts_pial_2017; @mcconnell_cerebral_2016] can be gained. To gather quantitative data of human angioarchitacture to —for example— inform modern blood-flow simulations [@park_quantification_2020; ii_multiscale_2020], detailed segmentations of smallest vessels are required. 
