...
![*VesselBoost*'s results of Prediction for four angiographic data with different isotropic resolution \label{fig:2}](fig2_pred_v4.png)
...
![*VesselBoost*'s results of TTA. The areas in the red circles show the missing small vessels in the predictions, the details have been supplemented after TTA. \label{fig:3}](fig3_tta_v4.png)
...
![*VesselBoost*'s results of Boost. The areas in the red circles show that more details of the small vessels have been revealed after the 'boosting' process. \label{fig:4}](fig4_boost_v2.png)
...
![Other considerations. (a) Segmentations before (left) and after (right) skull masking. (b) Segmentations with different post-processing thresholds for disconnected components removal. \label{fig:7}](figure7_v8.png)
