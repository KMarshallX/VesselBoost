...
![Quantitative evaluation on 300 um image data. A model pre-trained on suboptimal segmentations used for test-time adaptation, the result showed an increase in Dice score.  \label{fig:3}](figure4_v3.png)
