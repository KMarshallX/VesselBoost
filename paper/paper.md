...
![*VesselBoost* overview. (a) The test-time adaptation module (or Module 1) includes image pre-processing (i), model adaptation (ii), and post-processing (iii). (b) If no proxy is provided to the TTA module, a proxy segmentation is generated by the prediction module (Module 2), which includes image pre-processing (i), prediction using our pre-trained models (ii), and post-processing (iii).\label{fig:1}](figure1_v1.png)
