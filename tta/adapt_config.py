...
adapt_parser.add_argument('--optim_gamma', type=float, default=0.8, help=argparse.SUPPRESS)
...
adapt_parser.add_argument('--optim_patience', type=int, default=100, help=argparse.SUPPRESS)
