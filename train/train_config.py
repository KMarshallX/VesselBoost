...
train_parser.add_argument('--inimg', default = "./data/raw/", help="input image path")
train_parser.add_argument('--inlab', default = "./data/seg/", help="input ground truth path")
...
train_parser.add_argument('--optim_gamma', type=float, default=0.8, help=argparse.SUPPRESS)
