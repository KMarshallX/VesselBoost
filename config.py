...
# test.py
parser.add_argument('--tinimg', default = "./data/raw1/", help="input image path for test")
parser.add_argument('--tinlab', default = "./data/seg1/", help="input ground truth path for test")
