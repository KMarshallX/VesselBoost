...
train_parser.add_argument('--augmentation_mode', type=str, default="spatial", help="available: [all, off, random, spatial, intensity, flip]")
train_parser.add_argument('--crop_low_thresh', type=int, default=64, help="lower threshold for random crop minimum size, used in augmentation")
